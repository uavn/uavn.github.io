import { init, load, Sprite, TileEngine, SpriteSheet } from 'kontra';
import { GameLoop, Text, keyPressed, initInput } from './fw';
import './style.css';
    ...
    async loadWorldResources(gameLevel) {
        ...
        return load(spriteSheet)
            .then(([image]) => {
                ...
                let playerSpriteSheet = new SpriteSheet({
                    image,
                ...
                let horseSpriteSheet = new SpriteSheet({
                    image,
